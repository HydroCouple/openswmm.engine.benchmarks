#!/usr/bin/env python3
"""analytical/swashes — SCAFFOLD STUB.

1D solvers and the 2D shallow-water engine against analytical solutions
(Delestre et al. 2013, SWASHES) on a case x solver matrix. reference.class =
