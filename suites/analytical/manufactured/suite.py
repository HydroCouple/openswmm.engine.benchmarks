#!/usr/bin/env python3
"""analytical/manufactured — SCAFFOLD STUB.

Manufactured / exact-by-construction solutions: infiltration, groundwater
recession, ODE integrators, quality decay, cross-section geometry.
reference.class = manufactured.
