# Legacy repository overview (pre-restructure)

Preserved from the original `readme.md` at commit 3725238, before
the benchmark-platform restructure. Kept because it documents the pre-migration
directory layout that the corpus migration (plan step 3) maps into tags.
